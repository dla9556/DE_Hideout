...
> 기준일: 2026-03-11 | 기획서: `Dosc/설정파일. md`
...
flowchart TD
    ...
    HUB -->|로드아웃 & 장비 탭| LOADOUT["로드아웃 & 장비 (HUD 오버레이)"]
...
| 로드아웃 & 장비 | ZONE-A 로드아웃 & 장비 탭 / ZONE-E 인벤토리 탭 | HUD 오버레이 |
...
HUD 헤더 오른쪽에 **재화 보유량(골드 · 크리스탈) 상시 표시**, 각 재화 호버 시 설명 툴팁
...
진입: ZONE-A 로드아웃&장비 탭 / ZONE-E 인벤토리 버튼 → HUD 오버레이
