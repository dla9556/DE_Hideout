...
> 기준일: 2026-03-11 | 기획서: `Dosc/design-spec.md`
...
| 4 | 장비 슬롯 + 배낭 패널 | flex | 상단: 장비 / 하단: 배낭 |
...
주무기 · 보조무기 · 헬멧 · 상의 · 하의 · 장갑 · 신발 · 액세서리 · **배낭** (하단 단독 행)
...
| 항목 | Zone | 현재 동작 |
|------|------|----------|
| 퀘스트 탭 | ZONE-A | 클릭 시 '구현 예정 안내' 메시지 |
| 우편함 탭 | ZONE-A / HUD 오버레이 | 클릭 시 '구현 예정 안내' 메시지 |
| 퀘스트 추적기 위젯 | ZONE-B | UI 자리만 표시 |
